...
class MultiMa(IStrategy):
    ...
    buy_ma_gap = IntParameter(1, gap_max, default=10, space="buy")

    sell_ma_count = IntParameter(1, count_max, default=3, space="sell")
    sell_ma_gap = IntParameter(1, gap_max, default=10, space="sell")
